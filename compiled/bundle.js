...
},{"core-js/fn/regexp/escape":2,"core-js/shim":324,"regenerator-runtime/runtime":326}],2:[function(require,module,exports){
...
var _NewsBlock = require("./components/NewsBlock.js");

var _NewsBlock2 = _interopRequireDefault(_NewsBlock);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function newsHandler() {
   var handler = new _NewsBlock2.default();
...
},{"./components/NewsBlock.js":330,"babel-polyfill":1,"promise-polyfill":325,"whatwg-fetch":327}],329:[function(require,module,exports){
'use strict';
    ...
    _createClass(NewsBlock, [{
        ...
        value: function displayNews() {
            ...
            for (var i = 0; i < news.length; i++) {
                var article = new _Article2.default(news[i]);
        ...
        get: function get() {
            ...
            return _config.config.apiUrl + 'top-headlines?sources=' + selectedChannel + '&apiKey=' + _config.config.apiKey;
        }
    }]);
...
},{"../config.js":331,"./Article.js":329}],331:[function(require,module,exports){
'use strict';
...
var config = exports.config = {
	apiKey: '47d4a25cf54f4af0a8ee36e2b5f0cdeb',
